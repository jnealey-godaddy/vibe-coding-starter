...
export const levels: Level[] = [
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        proTip: "In real GoDaddy repos, you can ask AI to find EID event instrumentation the same way -- \"What EID fires when a user clicks [button]?\"",
      },
      {
        id: "1-6",

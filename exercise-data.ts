    ...
    exercises: [
      {
        ...
        outcome: "AI tells you WordPress has 7 sites, Managed WordPress has 4, Websites + Marketing has 4.",
        proTip: null,
      },
      {
        id: "3-2",
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        hint: "Add a pie chart showing what percentage of sites use each product type (WordPress, Managed WordPress, Websites + Marketing). Use a CSS conic-gradient approach -- no library needed. Include a color legend so the chart is readable.",
        outcome: "A pie chart appears with 3 segments showing the product mix, with a legend identifying each color.",
        proTip: null,
      },
      {
        id: "7-3",

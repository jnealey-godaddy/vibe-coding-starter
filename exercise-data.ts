...
export const levels: readonly Level[] = [
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        instructions: "In Cursor's terminal, run:\nbrew install gh\nWindows? Run winget install GitHub.CLI instead.",
        verify: "Run gh --version -- you should see a version number.",
        proTip: "The GitHub CLI (gh) is the easiest way to authenticate Git with your GitHub account. It also lets you create pull requests, browse issues, and more -- all from the terminal.",
      },
      {
        id: "0-7",
        title: "Authenticate with GitHub",
        instructions: "In Cursor's terminal, run:\ngh auth login\nChoose \"GitHub.com\", then \"HTTPS\", then \"Login with a web browser\". It will give you a one-time code -- copy it, press Enter, and sign in through the browser page that opens.",
        verify: "Run gh auth status -- you should see your GitHub username and \"Logged in to github.com\".",
        proTip: "This signs you in once and Git remembers your credentials. You won't need to enter a password every time you push or pull.",
      },
      {
        id: "0-8",
        title: "Clone this project",
        instructions: "In Cursor, press Cmd+Shift+P (Ctrl+Shift+P on Windows) to open the Command Palette, then type \"Git: Clone\" and select it. Paste this URL:\nhttps://github.com/jnealey-godaddy/vibe-coding-starter\nChoose a folder to save it in, then click \"Open\" when Cursor asks if you want to open the cloned repository.",
        verify: "The left sidebar shows index.html, main.ts, style.css, data/, and other project files.",
        proTip: "\"Clone\" means \"download a copy.\" Your computer now has a full copy you can change without affecting anyone else. Cursor's built-in clone handles the Git URL and folder selection in one step.",
      },
      {
        id: "0-9",
